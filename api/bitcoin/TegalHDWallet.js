...
/**!!!
 * A Tegal Hierarchical Deterministic (HD) Wallet JS Implementation
 * 
...
export default class TegalHDWallet {
    ...
    constructor() {
        ...
        /**
         * Tegal Legacy Address - Derived from the Grand Child Public Key Hash
         */

        this.tegalLegacyAddress = ''

        /**
         * TESTNET Tegal Legacy Address (Derived from the Grand Child Public Key Hash) - THIS IS TESTNET
         */

        this._ttegalLegacyAddress = ''
    ...
    generateSeedHash(seed) {
        ...
        const tgl = utils.stringtoUTF8Array('TGL');
        const buffer = utils.appendBuffer(seed.reverse(), tgl);
    ...
    generateDerivedChildKeys() {
        ...
        const derivePublicGrandChildKey = () => {
            ...
            // Append CheckSum
            const _tegalLegacyAddress = k.concat(...addressCheckSum)

            // Convert to Base58
            this.tegalLegacyAddress = Base58.encode(_tegalLegacyAddress)


            /**
             * Derive TESTNET Tegal Legacy Address
             */
            ...
            // Append CheckSum
            const _ttegalLegacyAddress = tK.concat(...tAddressCheckSum)

            // Convert to Base58
            this._ttegalLegacyAddress = Base58.encode(_ttegalLegacyAddress)
        }
    ...
    returnWallet() {
        ...
        const wallet = {
            ...
            address: this.tegalLegacyAddress,
            _taddress: this._ttegalLegacyAddress
        }
