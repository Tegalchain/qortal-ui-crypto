...
/**!!!
 * A Tegacoin Hierarchical Deterministic (HD) Wallet JS Implementation
 * 
...
export default class TegacoinHDWallet {
    ...
    constructor() {
        ...
        /**
         * Tegacoin Legacy Address - Derived from the Grand Child Public Key Hash
         */

        this.tegacoinLegacyAddress = ''

        /**
         * TESTNET Tegacoin Legacy Address (Derived from the Grand Child Public Key Hash) - THIS IS TESTNET
         */

        this._ttegacoinLegacyAddress = ''
    ...
    generateSeedHash(seed) {
        ...
        const tega = utils.stringtoUTF8Array('TEGA');
        const buffer = utils.appendBuffer(seed.reverse(), tega);
    ...
    generateDerivedChildKeys() {
        ...
        const derivePublicGrandChildKey = () => {
            ...
            /**
             * Derive Tegacoin Legacy Address
             */
            ...
            // Append CheckSum
            const _tegacoinLegacyAddress = k.concat(...addressCheckSum)

            // Convert to Base58
            this.tegacoinLegacyAddress = Base58.encode(_tegacoinLegacyAddress)


            /**
             * Derive TESTNET Tegacoin Legacy Address
             */
            ...
            // Append CheckSum
            const _ttegacoinLegacyAddress = tK.concat(...tAddressCheckSum)

            // Convert to Base58
            this._ttegacoinLegacyAddress = Base58.encode(_ttegacoinLegacyAddress)
        }
    ...
    returnWallet() {
        ...
        const wallet = {
            ...
            address: this.tegacoinLegacyAddress,
            _taddress: this._ttegacoinLegacyAddress
        }
